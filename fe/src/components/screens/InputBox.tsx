export default function InputBox({ label, type, value, setValue, disabled }: { label: string, type: string, value: string, setValue: React.Dispatch<React.SetStateAction<string>>, disabled?: boolean }) {
    return <div>
